        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
            <div className="flex h-full">
                ...
                <div className="p-8 pb-4 flex-2">
                    ...
                    <Link href={`/courses/${course.slug}`} className="block mt-1 text-sm xs:text-base leading-tight font-medium text-black hover:underline">
                        {course.title}
                    </Link>
                    <p className="mt-2 mb-4 text-sm xs:text-md text-gray-500">
